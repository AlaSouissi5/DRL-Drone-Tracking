...
class DenseActor(BasePolicy):
    ...
    def __init__(
        ...
        # calculate the features dim manually
        self.features_dim = 40608
        ...
        self.latent_pi = DenseMlp(self.features_dim, -1, net_arch[0])
...
register_policy("AsyncPolicy", SACDensePolicy)